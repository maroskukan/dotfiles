...
-- Window collision focus, use with Ctrl+Super+Space
-- Then Shift+Super+Arrow Keys
require("collision")()
...
-- Custom Autorun programs
awful.spawn.with_shell("picom")
awful.spawn.with_shell("nm-applet")
awful.spawn.with_shell("kmix")
awful.spawn.with_shell("$HOME/.config/polybar/launch.sh")
awful.spawn.with_shell("feh --randomize --bg-fill $HOME/Media/wallpapers")
